...
class MultiColumnInspection extends BasePage {
    ...
    async multicolumnInspectionSubmission() {
        ...
        await this.click_on_inspection('Multi column Inspection');
        await this.waituntilLoaderToDisappear();
...
export default new MultiColumnInspection();
