...
class periodicwithawo extends BasePage {
    ...
    async createPeriodicwithawo() {
        await this.openCreateNewInspection('Create New Inspection');
        logger.info("start Periodic Condition Inspection with connected airfield workorder ");
        await this.click_on_inspection('PERIODIC CONDITION INSPECTION CHECKLIST');
        ...
        logger.info("Periodic Condition Inspection with connected airfield workorder completed successfully");

    }
}
export default new periodicwithawo();