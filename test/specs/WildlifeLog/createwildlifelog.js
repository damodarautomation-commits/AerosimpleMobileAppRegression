...
import SubmitWildLifeLog from '../../pageobjects/WildlifeLog/createnoactivity.js';
...
describe('WildLife', function () {
    ...
    it('Create Wildlife Log with No Activity Submission', async function () {
        try {
            ...
            await SubmitWildLifeLog.createNewWildLifeLog(wildLife.wildLifeSubModules[1]);

            logger.info('WildLife None/No Activity submission completed successfully ');
        } catch (err) {
