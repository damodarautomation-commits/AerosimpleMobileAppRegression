...
import SubmitEditWildLifeLog from '../../pageobjects/WildlifeLog/editwildlifelog.js';
...
describe('WildLife', function () {
    ...
    it('Edit Wildlife Log with  Submission', async function () {
        try {
            ...
            await SubmitEditWildLifeLog.editwildlifeLogsubmission(wildLife.wildLifeSubModules[1]);
