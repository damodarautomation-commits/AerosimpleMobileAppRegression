...
import safetyHazardCorrectiveAction from '../../pageobjects/SMS/correctiveaction.js';
...
describe('Safety Management System (SMS)', function () {
    ...
    it('Create Corrective action to safety hazard.', async function () {
        ...
        await driver.waitUntil(
            async () => {
                ...
                await safetyHazardCorrectiveAction.clickOnApps();
                await Search_Module.openModule(SMS.Module);
                await Search_Module.waitForLoaderToDisappear();
        ...
        await safetyHazardCorrectiveAction.correctiveactions();
    });
});