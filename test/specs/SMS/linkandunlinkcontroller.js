...
import safetyHazard_relatedhazard from '../../pageobjects/SMS/releatedhazard.js';
...
describe('Safety Management System (SMS)', function () {
    ...
    it('Verify related hazard functionality.', async function () {
        ...
        await driver.waitUntil(
            async () => {
                ...
                await safetyHazard_relatedhazard.clickOnApps();
                await Search_Module.openModule(SMS.Module);
                await Search_Module.waitForLoaderToDisappear();
        ...
        await safetyHazard_relatedhazard.relatedhazard();
    });
});