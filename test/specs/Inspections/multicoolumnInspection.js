...
import MultiColumnInspection from '../../pageobjects/inspections/multicolumn.js';
...
describe('Inspections', function () {
    ...
    it('Multi Coulmn Inspection Submission', async function () {
        try {
            ...
            await MultiColumnInspection.multicolumnInspectionSubmission();

            logger.info('New Multi Column Inspection Submission completed successfully ');
        } catch (err) {
