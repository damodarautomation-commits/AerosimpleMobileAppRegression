...
import TolarenceEditInspection from '../../pageobjects/inspections/edittolerance.js';
import { logger } from '../../utils/executionLogger.js';

describe('Inspections', function () {
    this.timeout(800000);

    it('Edit Tolerance Inspection Submission', async function () {
        try {
            ...
            await TolarenceEditInspection.EditToleranceInspection()
