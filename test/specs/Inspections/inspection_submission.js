...
import CreateInspection from '../../pageobjects/inspections/sumission.js';
...
describe('Inspections', function () {
    ...
    it('Create New Airport Safety Self-Inspection without comments', async function () {
        try {
            ...
            await CreateInspection.submitNewInspection()
