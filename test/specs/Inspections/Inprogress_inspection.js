...
import Inprogress from '../../pageobjects/inspections/inprogress.js';
import { logger } from '../../utils/executionLogger.js';

describe('Inspections', function () {
    this.timeout(800000);

    it('Verify Inspection In-Progress Functionality', async function () {
        try {
            ...
            await Inprogress.InprogressInspection();

            logger.info('Inspection In-Progress Functionality completed successfully ');
        } catch (err) {
